...
public class AdminDashboardWindow implements ActionListener {
   ...
   public AdminDashboardWindow() throws SQLException{
     ...
     AdminFrame.getContentPane().setBackground(new Color(253,226,149));
    ...
    // Creating Side bar Text
     JLabel headerText = new JLabel();
        ImageIcon HeaderImage = new ImageIcon(new ImageIcon("C:\\\\Users\\\\The Only Supplier\\\\eclipse-workspace\\\\FoundAndLostSystem\\\\src\\\\img\\\\adminPic2.png").getImage().getScaledInstance(120, 120, Image.SCALE_DEFAULT));
    ...
    totalCustomers.setBackground(new Color(92, 64, 51));
    ...
    ImageIcon totalCustomersImage = new ImageIcon(new ImageIcon("C:\\\\Users\\\\The Only Supplier\\\\eclipse-workspace\\\\FoundAndLostSystem\\\\src\\\\img\\\\customers.png").getImage().getScaledInstance(180, 180, Image.SCALE_DEFAULT));
    ...
    viewTotalCustomersBtn.setForeground(new Color(92, 64, 51));
    ...
    manageProducts.setBackground(new Color(92, 64, 51));
    ...
    ImageIcon manageImage = new ImageIcon(new ImageIcon("C:\\\\Users\\\\The Only Supplier\\\\eclipse-workspace\\\\FoundAndLostSystem\\\\src\\\\img\\\\managePic.png").getImage().getScaledInstance(180, 180, Image.SCALE_DEFAULT));
